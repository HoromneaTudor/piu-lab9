...
namespace InterfataUtilizator
{
    public partial class FormularStudent : Form
    {
        ...
        {
            //ckbPCLP.Text = "PCLP" + cmbAnStudiu.Text;
            //ckbDEEA.Text = "DEEA1" + cmbAnStudiu.Text;
            //ckbED.Text = "ED" + cmbAnStudiu.Text;
            //ckbMEST.Text = "MEST" + cmbAnStudiu.Text;
            //ckbPIU.Text = "PIU" + cmbAnStudiu.Text;
            //ckbPOO.Text = "POO" + cmbAnStudiu.Text;
            ckbPCLP.Show();
            ckbDEEA.Show();
            ckbED.Show();
            ckbMEST.Show();
